Welcome to tpp's documentation!
=====================================
...
tpp is a PyTorch library which implements a fast approximate inference method for latent variable models. For details, see the paper [TODO].

Demos for variational inference and Markov Chain Monte Carlo are available.
...
tpp introduces a number of PyTorch modules mirroring the standard pytorch ``nn`` API.
