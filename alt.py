...
class TraceSample(Trace):
    """
    Just used e.g. to test a program or to sample from the prior, 
    and as such it doesn't make sense for it to take data as input.
    No K's.
    """
    def __init__(self):
...
#### Example
"""
    Ks now on the right of the names list.
    hence we add padding for init methods
    and also for params:     
"""
